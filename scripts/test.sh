...
docker run -v ~/.go:/go -v ${DIR}/../testing:/go/src/github.com/commnerd/SpiderWeb/testing -v ${DIR}/../lib:/workspace -w /workspace -e  CGO_ENABLED=0 -it --rm --name sw-SpiderWeb-cli-builder golang bash -c "go get -d && go test"
