...
docker run -v ~/.go:/go -v ${DIR}/..:/go/src/github.com/commnerd/SpiderWeb -v ${DIR}/..:/workspace -w /workspace/lib/ids -it --rm --name sw-SpiderWeb-lib-tester golang bash -c "go get -d && go test"
